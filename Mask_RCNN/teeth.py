...
class TeethDataset(utils.Dataset):
    ...
    def load_teeth(self, dataset_dir, subset):
        ...
        self.add_class("teeth", 1, "kirik")
        self.add_class("teeth", 2, "bosluk")
        self.add_class("teeth", 3, "dolgu")
        self.add_class("teeth", 4, "kanal_tedavi")
        self.add_class("teeth", 5, "implant")
        self.add_class("teeth", 6, "curuk")
        self.add_class("teeth", 7, "yirmilik_dis")
        self.add_class("teeth", 8, "tel")
        self.add_class("teeth", 9, "saglikli")
        self.add_class("teeth", 10, "plak")
        self.add_class("teeth", 11, "dis_tasi")
